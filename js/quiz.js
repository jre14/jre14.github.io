...
const   divForm = document.getElementById("form"),
        ...
        divQuestions = document.getElementById("containerQuestions"),
...
const results = () => {
    ...
    text.textContent = `${nameUser} ¡Felicidades has concluido ${category}!`;
...
start.onclick = () => {
    ...
    if(datoUser == ""){
        ...
        user(datoUser);
        text.textContent = `Bienvenido ${nameUser}, comenzemos eligiendo una categoria`;
    }
}
...
generalCulture.onclick = () => {
    ...
    countOption(array);
    text.textContent = `${nameUser} has elegido: Cultura General`;  
    nQuestion();
    nOption();
    startQuiz();
...
futbol.onclick = () => {
    ...
    countOption(array);
    text.textContent = `${nameUser} has elegido: Futbol`;  
    nQuestion();
    nOption();
    startQuiz();
